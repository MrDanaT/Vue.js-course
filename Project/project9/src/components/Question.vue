    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-xs-12 col-sm-6 text-center">
                <button @click="onAnswer(btnData[0].correct)" class="btn btn-primary btn-lg" style="margin: 10px">{{
                    btnData[0].answer }}
                </button>
            </div>
            <div class="col-xs-12 col-sm-6 text-center">
                <button @click="onAnswer(btnData[1].correct)" class="btn btn-primary btn-lg" style="margin: 10px">{{
                    btnData[1].answer }}
                </button>
            </div>
            <div class="col-xs-12 col-sm-6 text-center">
                <button @click="onAnswer(btnData[2].correct)" class="btn btn-primary btn-lg" style="margin: 10px">{{
                    btnData[2].answer }}
                </button>
            </div>
            <div class="col-xs-12 col-sm-6 text-center">
                <button @click="onAnswer(btnData[3].correct)" class="btn btn-primary btn-lg" style="margin: 10px">{{
                    btnData[3].answer }}
                </button>
            </div>
        </div>
