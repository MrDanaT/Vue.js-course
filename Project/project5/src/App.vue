    ...
    <form>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
          <div class="form-group">
            <label for="sendmail">
              <input id="sendmail" type="checkbox" v-model="sendMail" value="SendMail"/> Send Mail
            </label>
            <label for="sendInfomail">
              <input id="sendInfomail" type="checkbox" v-model="sendMail" value="SendInfoMail"/> Send Infomail
            </label>
          </div>
        </div>
      </div>
